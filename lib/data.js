...
export const blogPosts = [
  {
    ...
    excerpt: "Comprehensive organic search architecture covering algorithmic updates, technical crawlability, and conversion-optimized keyword siloing for modern businesses.",
  ...
  },
  {
    ...
    excerpt: "A practical guide to Entity-Based SEO and Google Knowledge Graph acquisition. Learn how search engines connect people, organizations, and concepts, and how to verify your digital entity.",
  ...
  "excerpt": "Master technical SEO for custom PHP and Laravel applications. Learn URL routing, dynamic XML sitemaps, server-side OpenGraph/Schema injection, OPcache speed tuning, and canonical structure.",
  "summary": "Custom PHP websites offer unparalleled flexibility and speed, but without native CMS plugins (like Yoast or RankMath), technical SEO must be engineered directly into the backend architecture. This comprehensive blueprint outlines the exact server-side configurations, routing rules, schema generators, and Core Web Vitals optimizations required to outrank competitors on Google.",
  "meta_title": "PHP Website SEO: The Complete Guide to Ranking Custom PHP Sites in 2026 | Abdullah Saleh",
  "meta_description": "Master technical SEO for custom PHP and Laravel websites. Learn how to engineer clean URL rewrites, dynamic XML sitemaps, automated Schema.org markup, and lightning-fast TTFB to rank #1 on Google.",
...
},
  {
    ...
    summary: "The definitive 2026 playbook for Wix SEO. Discover how to configure URL redirects, custom Schema markup, Core Web Vitals speed optimization, canonical tags, and how Abdullah Saleh helps Wix business owners rank #1 on Google.",
    excerpt: "The definitive 2026 playbook for Wix SEO. Discover how to configure URL redirects, custom Schema markup, Core Web Vitals speed optimization, canonical tags, and how Abdullah Saleh helps Wix business owners rank #1 on Google.",
    tags: ["Wix SEO", "Technical SEO", "Google Rankings", "Core Web Vitals", "E-Commerce SEO", "Schema Markup"],
    author: {
      name: "Abdullah Saleh",
      role: "Lead SEO Strategist & AI Search Architect",
  ...
  },
  {
    ...
    excerpt: "The definitive e-commerce organic growth manual. Learn how to optimize category hierarchy, product schema, review rich snippets, and faceted URLs to drive high-converting commercial organic traffic.",
  ...
  },
  {
    ...
    "excerpt": "Discover how to build semantic topic silos and keyword clusters that signal complete topical authority to Google algorithms, allowing newer sites to outperform high-DR legacy competitors.",
    "tags": [
      "Topical Authority",
      "Keyword Clustering",
      "Topic Silos",
    ...
    "meta_title": "Topical Authority & Semantic Keyword Clustering: Outranking High-DR Competitors"
  },
  {
    "id": 1,
    ...
    "excerpt": "Step-by-step masterclass on optimizing Core Web Vitals. Diagnose and fix Interaction to Next Paint (INP), Largest Contentful Paint (LCP), and Cumulative Layout Shift (CLS) for superior user experience and rank growth.",
    "tags": [
      "Core Web Vitals",
      "INP",
      "LCP",
    ...
    "dateModified": "2026-09-13",
    "meta_title": "The Ultimate Core Web Vitals Optimization Guide: Fixing INP, LCP & CLS for Higher Rankings"
  },
  {
    "id": 2,
    ...
    "dateModified": "2026-09-13",
    "meta_title": "Answer Engine Optimization (AEO) Blueprint: How to Win Zero-Click Searches & Voice AI in 2026"
  },
  {
    "id": 3,
    ...
    "dateModified": "2026-09-13",
    "meta_title": "AI Search Dominance: How to Optimize Your Brand for Perplexity, ChatGPT Search, and Google Gemini in 2026"
  },
  {
    "id": 4,
    ...
    "dateModified": "2026-09-13",
    "meta_title": "Generative Engine Optimization (GEO): How to Rank in Google AI Overviews & ChatGPT in 2026"
  },
  {
    "id": 5,
    ...
    "dateModified": "2026-09-13",
    "meta_title": "The Complete Technical SEO Audit Checklist for 2026"
  },
  {
    "id": 6,
    ...
    "dateModified": "2026-09-13",
    "meta_title": "Search Intent Mastery: How to Rank for High-Converting Commercial Keywords"
  },
  {
    "id": 7,
    ...
    "dateModified": "2026-09-13",
    "meta_title": "E-Commerce Faceted Navigation SEO: How to Prevent Crawl Waste & Cannibalization"
  }
];
