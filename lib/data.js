...
export const blogPosts = [
  {
    ...
    content: `
      ...
      <div style="background: linear-gradient(135deg, #eef2ff 0%, #edf2fe 100%); border: 1px solid #c7d2fe; border-radius: 12px; padding: 26px; margin: 34px 0; text-align: center;">
        ...
        <a href="/contact" style="display: inline-block; background: #4361ee; color: #ffffff; padding: 12px 28px; border-radius: 8px; font-weight: 700; text-decoration: none; box-shadow: 0 4px 14px rgba(67, 97, 238, 0.3);">
