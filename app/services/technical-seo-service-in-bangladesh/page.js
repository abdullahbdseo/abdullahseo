          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, maxWidth: "780px", margin: "0 auto" }}>
              ...
              <div style={{
                ...
                <i className="fa-solid fa-gears" style={{ color: "#60a5fa" }}></i>
                <span>Forensic Technical Search Architecture</span>
              </div>
              ...
              <p style={{
                ...
                Get a free forensic technical crawl audit of your website. I will systematically identify the exact crawl, speed, and indexing bottlenecks blocking your rankings and deliver an actionable fix roadmap.
              </p>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                  ...
                  <span>230+ Point Forensic Crawl</span>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                  <i className="fa-solid fa-award" style={{ color: "#60a5fa" }}></i>
                  <span>Core Web Vitals & Speed Master</span>
                </div>
              </div>
            </div>
          </div>
