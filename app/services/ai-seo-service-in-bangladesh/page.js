          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, maxWidth: "780px", margin: "0 auto" }}>
              ...
              <div style={{
                ...
                <i className="fa-solid fa-brain" style={{ color: "#60a5fa" }}></i>
                <span>Generative &amp; AI Search Engine Optimization</span>
              </div>
              ...
              <h2 style={{
                ...
                Ready to Future-Proof Your Search Traffic with <span style={{
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                  ...
                  <span>GEO, AEO &amp; Entity Search</span>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                  <i className="fa-solid fa-award" style={{ color: "#60a5fa" }}></i>
                  <span>AI Overviews &amp; Perplexity Citations</span>
                </div>
              </div>
            </div>
          </div>
