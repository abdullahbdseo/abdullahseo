          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, maxWidth: "780px", margin: "0 auto" }}>
              ...
              <div style={{
                ...
                <i className="fa-solid fa-map-location-dot" style={{ color: "#60a5fa" }}></i>
                <span>Google Maps 3-Pack Growth Acceleration</span>
              </div>
              ...
              <p style={{
                ...
                Stop letting nearby competitors capture your phone calls and foot traffic. Get a 100% free Local SEO audit and discover the exact roadmap to rank your business in the Google 3-Pack within 60 to 90 days.
              </p>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                  ...
                  <span>100% White-Hat Google Terms</span>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                  <i className="fa-solid fa-award" style={{ color: "#60a5fa" }}></i>
                  <span>100+ Ranked Local Businesses</span>
                </div>
              </div>
            </div>
          </div>
