    ...
    <div className="about-page-wrapper">
      <div className="container" style={{ maxWidth: "1240px", margin: "0 auto", padding: "0 20px" }}>
        ...
        <div className="about-layout-grid">
          ...
          <aside className="about-sidebar-toc">
            <nav className="about-sidebar-toc-nav">
              <ul className="about-sidebar-toc-list">
                <li>
                  <a href="#about-expert" className="about-toc-link active">
                    <i className="fa-regular fa-user" style={{ width: "16px" }}></i>
                    <span>SEO Expert Profile</span>
                  </a>
                </li>
                <li>
                  <a href="#philosophy" className="about-toc-link">
                    <i className="fa-regular fa-eye" style={{ width: "16px" }}></i>
                    <span>SEO Philosophy</span>
                  </a>
                </li>
                <li>
                  <a href="#expertise" className="about-toc-link">
                    <i className="fa-solid fa-layer-group" style={{ width: "16px" }}></i>
                    <span>Core Expertise</span>
                  </a>
                </li>
                <li>
                  <a href="#ai-search" className="about-toc-link">
                    <i className="fa-solid fa-microchip" style={{ width: "16px" }}></i>
                    <span>AI SEO &amp; Future</span>
                  </a>
                </li>
                <li>
                  <a href="#testimonials" className="about-toc-link">
                    <i className="fa-solid fa-star" style={{ width: "16px", color: "#fbbf24" }}></i>
                    <span>Verified Reviews</span>
                  </a>
                </li>
                <li>
                  <a href="#why-choose" className="about-toc-link">
          ...
          <div className="about-content-area">
            ...
            <section id="about-expert" style={{ scrollMarginTop: "100px" }}>
              <div className="about-profile-card">
                <div className="about-profile-flex">
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <h2 style={{ fontSize: "clamp(1.25rem, 3vw, 1.5rem)", fontWeight: 800, color: "#0f172a", marginBottom: "4px" }}>
                      Abdullah Saleh
                    </h2>
                ...
                <div className="about-stats-grid">
                  <div className="about-stat-box">
                    <div className="about-stat-number">6+ Years</div>
                    <div className="about-stat-label">Hands-On Experience</div>
                  </div>
                  <div className="about-stat-box">
                    <div className="about-stat-number">100+ Clients</div>
                    <div className="about-stat-label">Local &amp; International</div>
                  </div>
                  <div className="about-stat-box">
                    <div className="about-stat-number">100% White-Hat</div>
                    <div className="about-stat-label">Google Compliant</div>
                  </div>
                  <div className="about-stat-box">
                    <div className="about-stat-number" style={{ color: "#059669" }}>AI &amp; GEO Ready</div>
                    <div className="about-stat-label">LLM &amp; AEO Optimization</div>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section id="philosophy" style={{ scrollMarginTop: "100px" }}>
              ...
              <div className="about-section-card">
                <h3 style={{ fontSize: "clamp(1.15rem, 2.5vw, 1.3rem)", fontWeight: 800, color: "#0f172a", marginBottom: "12px" }}>
            ...
            <section id="expertise" style={{ scrollMarginTop: "100px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "#eff6ff", border: "1px solid #dbeafe", padding: "6px 14px", borderRadius: "4px", fontSize: "0.85rem", fontWeight: 700, color: "#0062d2", marginBottom: "14px" }}>
            ...
            <section id="ai-search" style={{ scrollMarginTop: "100px" }}>
            ...
            <section id="why-choose" style={{ scrollMarginTop: "100px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "#eff6ff", border: "1px solid #dbeafe", padding: "6px 14px", borderRadius: "4px", fontSize: "0.85rem", fontWeight: 700, color: "#0062d2", marginBottom: "14px" }}>
            ...
            <div className="about-cta-container">
              <h2 style={{ color: "#ffffff", fontSize: "clamp(1.3rem, 3.5vw, 1.8rem)", marginBottom: "8px", fontWeight: 800 }}>Ready to Grow Your Business Organically?</h2>
