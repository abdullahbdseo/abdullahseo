<?php
// views/public/errors/500.php
?>

<section class="section" style="padding: 120px 0; text-align: center;">
    <div class="container" style="max-width: 600px;">
        <div style="font-family: var(--font-heading); font-size: 6rem; font-weight: 800; color: var(--brand-warning); line-height: 1;">500</div>
        <h2 style="font-size: 2rem; margin: 16px 0;">Internal Server Error</h2>
